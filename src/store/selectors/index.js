...
export const isShowModalHistoryBidSelector = (state) =>
  state.products.isShowModalHistoryBid;

export const bidProductsListSelector = (state) =>
  state.products.bidProductsList;
