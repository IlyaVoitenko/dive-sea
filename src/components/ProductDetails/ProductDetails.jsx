...
const ProductDetails = () => {
  ...
  return (
    <div className="containerPage bg-[#FAFAFA]">
      ...
      <div className="flex flex-col justify-evenly mobile:justify-evenly items-center bg-[#FAFAFA] w-[90%] desktop:h-[1300px] laptop:h-[1000px] tablet:h-[800px] mobile:h-[2200px]  ">
