...
const UnleashRecentViewed = () => {
  return (
    <section className="absolute bg-[#FCFCFD] z-[2] drop-shadow-2xl flex flex-col justify-start items-center rounded-[16px] top-[61%] left-[16%] desktop:top-[51%] desktop:left-[11%] w-[340px] h-[215px] laptop:w-[229.07px] laptop:h-[154.39px]">
