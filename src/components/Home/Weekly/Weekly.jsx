...
const Weekly = () => {
  ...
  return (
    <div className="relative flex flex-col justify-start items-center bg-[#F1F1F1] max-w-full  w-screen laptop:h-[989px] desktop:h-[800px] desktop:mt-[4rem] tablet:mt-[2.5rem] laptop:mt-[1rem]">
