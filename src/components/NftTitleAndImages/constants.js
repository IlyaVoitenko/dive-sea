...
// hr line
export const sizeLaptopHr = `laptop:w-[195px] `;
export const sizeTableHr = `tablet:w-[138.68px] `;

// NFT Title
export const sizeLaptopTitleNft = `laptop:text-[75px] laptop:leading-[90px] laptop:tracking-[-3px]`;
